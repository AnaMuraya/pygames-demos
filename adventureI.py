...
for i in range(num_platforms):
    ...
    #     previous_platform_y - player_height - platform_height - jump_force,
    #     previous_platform_y - player_height - platform_height
    # )
    # platforms.append(pygame.Rect(platform_x, platform_y, platform_width, platform_height))
    # previous_platform_y = platform_y

# Gem properties
gem_width, gem_height = 30, 30
# gem_x = random.randint(50, screen_width - gem_width - 50)
# gem_y = random.randint(50, min(platform.y for platform in platforms) - jump_force)
random_platform_number = random.randint(1,5)
random_platform = platforms[random_platform_number]
random_gemx = random.randint(random_platform.x-jump_force, random_platform.x+jump_force)
random_gemy = random.randint(random_platform.y-jump_force, random_platform.y+jump_force)
gem_x = random_gemx
gem_y = random_gemy
...
while running:
    ...
    lives_text = font.render("Timer: " + str(int(time.time() - start_time)), True, RED)
