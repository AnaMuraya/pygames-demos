...
#Background image
background_image = pygame.image.load("glassII/assets/background4.jpg")
background_image = pygame.transform.scale(background_image, (WIDTH, HEIGHT))

# Set up the glass
glass_image = pygame.image.load("glassII/assets/glass.png")
broken_glass_image = pygame.image.load("glassII/assets/brokenGlass.png")
glass_width = 100
glass_height = 20
...
animal_images = [
    pygame.image.load("glassII/assets/animal1.png"),
    pygame.image.load("glassII/assets/animal2.png"),
    pygame.image.load("glassII/assets/animal3.png"),
    pygame.image.load("glassII/assets/animal4.png"),
    pygame.image.load("glassII/assets/animal5.png")
]
animal_width = 100
animal_height = 100
animal_speed = 3
